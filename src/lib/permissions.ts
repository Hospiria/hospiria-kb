...
export const DEFAULT_ROLE_PERMISSIONS: Record<Role, Partial<Record<FeatureKey, Perm>>> = {
  ...
  junior_team_leader: {
    dashboard: VIEW, chat: VIEW, notes: ALL, sop_notes: ALL, sops: ALL, approve_sops: NONE, quizzes: VIEW,
  },
  agent: {
    dashboard: VIEW, chat: VIEW, notes: ALL, sop_notes: ALL, sops: VIEW, approve_sops: NONE, quizzes: VIEW,
  },
}
